...
export class TablesCreation1713529321268 implements MigrationInterface {
    name = 'TablesCreation1713529321268'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "movie" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "genres" "public"."movie_genres_enum" array NOT NULL, "description" character varying, "rating" integer NOT NULL, "pegi" "public"."movie_pegi_enum" NOT NULL DEFAULT '18', "duration" TIME, "year" integer, "image" character varying NOT NULL, "hasOscar" boolean NOT NULL DEFAULT false, "directorId" uuid, CONSTRAINT "UQ_a81090ad0ceb645f30f9399c347" UNIQUE ("title"), CONSTRAINT "CHK_c7aedeccc47939e904ca1a8669" CHECK ("rating" >= 0 and rating <= 100), CONSTRAINT "CHK_46d855c586f1d7ba9339dbc5ca" CHECK (duration >= '00:00:00' AND duration <= '24:00:00'), CONSTRAINT "PK_cb3bb4d61cf764dc035cbedd422" PRIMARY KEY ("id"))`);
